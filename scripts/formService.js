...
(function(){
    ...
    angular
        ...
        .factory('formservice', formservice);
            ...
            function getFormFromServer(type){
                var form ={};

                if(type=='requestinspection'){
                    //https://api.backand.com:443/1/objects/formTemplate/1

                    return $http({
                        method: 'GET',
                        url: Backand.getApiUrl() + '/1/objects/formTemplate/1',
                      });
                };
            }

            function getModelFromServer(type){
                var form ={};

                if(type=='requestinspection'){
                    https://api.backand.com:443/1/objects/form/1

                    return $http({
                        method: 'GET',
                        url: Backand.getApiUrl() + '/1/objects/form/1',
                      });
                };
            }
